...
import black.hole.filter.builder.FilterBuilder;
...
import black.hole.filter.lexer.LexerTokenMaskImpl;
import black.hole.filter.lexer.LexerTokenType;
import black.hole.filter.parser.BufferedParser;
import black.hole.filter.parser.conditional.ConditionEquals;
import black.hole.filter.parser.conditional.ConditionOrIn;
import black.hole.filter.parser.conditional.Conditional;
